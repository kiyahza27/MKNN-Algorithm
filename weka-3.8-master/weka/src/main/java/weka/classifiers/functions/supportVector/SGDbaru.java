 ...
 * 
 */
public class SGDbaru extends RandomizableClassifier implements
    UpdateableClassifier, OptionHandler, Aggregateable<SGDbaru> {
   ...
   */
  @Override
  public SGDbaru aggregate(SGDbaru toAggregate) throws Exception {
  ...
  public static void main(String[] args) {
    runClassifier(new SGDbaru(), args);
  }
}
